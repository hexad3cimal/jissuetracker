...
public class Projects extends SuperModelClass implements java.io.Serializable {
	...
	public Projects(String name, String description, String url, Date updatedOn, Set<User> users,
			Set<Issues> issueses, String manager) {
		this.name = name;
		this.description = description;
		this.url = url;
